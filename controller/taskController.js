...
const createTask = async(req, res)=>{
    ...
    effort_estimation, effort_spent, completion_date, SDLC_stage, release_version} = req.body;
    ...
    if(exists){
        ...
        effort_estimation, effort_spent, completion_date, SDLC_stage, release_version});
...
const updateTask = async(req, res)=>{
    ...
    if(exists){
        ...
        task_title, status, priority, timeline, effort_estimation, effort_spent, completion_date, SDLC_stage, release_version});
